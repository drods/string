...
def make_cases():
    ...
    values = [0, 21, 0.21, 123.213, -0.21, -123,123, -21, 0.1234567, 1234567.01]
    for value_ in values:
        for format_ in formats:
            ...
            number_test += 1
    # double.        
    values = [0, 21, 0.21, 123.213, -0.21, -123,123, -21, 0.12345678, 12345678.01]
    type_ = "double"
    specifier = "f"
    for value_ in values:
        for format_ in formats:
...
def make_calls():
    ...
    number_test = 0
    formats = ['-*.5', '-*.0', ' 5.', '-*.*', '*.*', '10.0', '10.5', '+10.10', ' 0.5', ' 0.0', ' 5.*', '010.10', ' 0.*', '*.10', '10.*', '.10', ' .*', ' 5.0', ' .', ' .0', ' .5', '-10.10', ' *.5', '+5.0', ' *.0', '+5.5', '010.*', '-.', '010.0', '5.', '010.5', '+5.*', '-.10', ' *.*', '0*.', '+10.', '00.*', '+.*', '-10.*', '-*.', '-*.10', ' *.', '-10.5', '+.5', '0.', '-10.0', '+.0', '+5.10', '+0.0', '10.', '+0.5', '010.', '+0.*', '00.5', '-10.', ' 0.', '00.0', '05.10', '+.', '+*.0', ' 10.10', '+*.5', '+.10', '05.', '+10.*', '-0.', '+10.5', '+10.0', '.*', '.', '.0', '.5', '+0.', ' 10.0', '*.0', '-0.10', '*.5', '-.0', '-.5', '5.10', '+*.*', '0.10', ' *.10', '10.10', ' 10.*', '00.10', '0*.10', '05.*', '05.5', ' 5.10', ' 0.10', '05.0', '0.0', '0.5', ' 5.5', '0.*', ' 10.5', '5.0', '5.5', '+*.', '0*.*', '0*.5', '0*.0', '5.*', '+*.10', '-5.*', '00.', '-0.*', '-0.5', '*.', '-0.0', '-5.5', '-5.0', ' 10.', ' .10', '+0.10', '-.*', '+5.', '-5.', '-5.10', '', ' 10', '010', ' ', '00', '05', '+', '*', '-', '0', '5', '0*', ' *', '-10', ' 0', ' 5', '10', '+10', '+*', '-*', '-5', '+0', '-0', '+5']
    #values = [0, 21, 0.21, 123.213, -0.21, -123,123, -21, 1.17549e-38, 3.40282e+38, -3.40282e+38, -1.17549e-38]
    values = [0, 21, 0.21, 123.213, -0.21, -123,123, -21, 0.12345678910111213, 12345678910111213.01]
    for value_ in values:
        for format_ in formats:
            ...
            number_test += 1
    # double.        
    #values = [0, 21, 0.21, 123.213, -0.21, -123,123, -21, 2.22507e-308, 1.79769e+308, -1.79769e+308]
    values = [0, 21, 0.21, 123.213, -0.21, -123,123, -21, 0.12345678, 12345678.01]
    type_ = "double"
    specifier = "f"
    for value_ in values:
