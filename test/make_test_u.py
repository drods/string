...
def make_cases():
    ...
    open_bracket = "{"
    close_bracket = "}"
    formats = ['*.', '05.', '0*.', '-0.', '0.0', '-*.5', '0.5', '-*.0', '0.*', '-*.*', '10.10', '10.', '.0', '5.0', '10.0', '.*', '10.5', '5.5', '-10.*', '-5.0', '-*.', '-*.10', '5.10', '0*.*', '.', '010.*', '0*.0', '*.10', '-10.5', '00.', '10.*', '0.', '-10.0', '.10', '*.0', '00.*', '-0.10', '-5.*', '-.0', '-.5', '-0.*', '-0.5', '0*.5', '-.*', '010.', '-0.0', '-5.5', '00.5', '-10.', '-10.10', '00.0', '5.*', '*.*', '05.10', '00.10', '0*.10', '-.10', '-.', '05.*', '.5', '010.0', '05.5', '5.', '*.5', '010.5', '05.0', '-5.', '010.10', '-5.10', '0.10', '', '010', '00', '0', '05', '*', '-', '-*', '-5', '-10', '5', '-0', '0*', '10']
